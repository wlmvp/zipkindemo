package com.wl.springtest1.config;
...
public class TracingConfiguration extends WebMvcConfigurerAdapter {
    ...
    @Bean
    Sender sender() {
        return OkHttpSender.create("http://192.168.119.158:9411/api/v2/spans");
    }
    ...
    @Bean
    Tracing tracing(@Value("${zipkin.service:service1}") String serviceName) {
